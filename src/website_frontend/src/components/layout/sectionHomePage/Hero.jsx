        ...
        <div className="container relative">
          <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
            <h1 className="h1 mb-6 text-n-1">
              <span className="block relative bg-linear-gradient bg-clip-text text-transparent">
                A Fast Blockchain.
              </span>
              Scalable AI.
            </h1>
            <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
              Unleash the power of generative AI within your visuals, journeying
                  ...
                  <ScrollParallax isAbsolutelyPositioned>
                    <div className="hidden md:flex absolute md:-left-[1.5rem] lg:-left-[3rem] xl:-left-[5.5rem] bottom-[12rem] px-2 py-2 bg-n-3/10 backdrop-blur border border-n-1/10 space-x-2 rounded-2xl">
                      ...
                      <div className="w-fit min-w-[12rem] border border-n-1/10 bg-n-3/10 rounded-xl px-2 py-1 flex flex-col">
                        <span className="body-2 text-n-1/90">
                          Uploaded Images
                        </span>
                        <span className="text-xs text-n-1/50 tracking-wider">
                          JPG / JPEG / PNG
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="hidden absolute md:-right-[1.5rem] lg:-right-[3rem] xl:-right-[5.5rem]  bottom-[9rem] px-2 py-2 bg-n-3/10 backdrop-blur border border-n-1/10 rounded-2xl md:flex flex-col">
                          ...
                          >
                            {index === 1 && (
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                className="absolute z-1 size-5 fill-accentColor right-1"
                              >
                      ...
                      <div className="w-full flex mt-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          className="size-5 fill-accentColor right-1"
                        >
                        ...
                        <span className="ml-2 text-left tagline">
                          Style Choosed
                        </span>
                      </div>
                    </div>
