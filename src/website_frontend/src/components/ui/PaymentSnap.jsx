  ...
  return (
    <>
      {showInvoice && paymentStatus !== "idle" && (
        <section
          className={`flex space-y-20 w-full h-full justify-center items-center fixed inset-0 bg-black/20 z-[999] backdrop-blur-sm place-items-center transition-opacity duration-300`}
        >
