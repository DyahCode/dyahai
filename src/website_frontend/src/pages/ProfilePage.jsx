  ...
  const asideItems = [
    {
      name: "Account Detail",
      icon:
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-7 stroke-[2px]">
    ...
    },
    {
      ...
      icon:
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-7 stroke-[1.5px]">
          <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
      ...
      <main className="bg-primaryColor h-full md:h-dvh w-full flex flex-col justify-between md:flex-row md:overflow-hidden">
        ...
        <section className="pt-[8dvh] w-full flex justify-end flex-row h-dvh">
          ...
          <section className="bg-secondaryColor border-borderShade text-fontPrimaryColor right-0 w-fit lg:min-w-[25rem] lg:w-[25rem] border-l-2 border-opacity-50 order-last flex flex-col justify-between p-2 lg:py-8 lg:px-10">
            ...
            <div className="">
              ...
              <ul className="py-2 flex flex-col gap-y-2">
                {asideItems.map((item, index) => (
                  ...
                  >
                    <div className={`text-2xl items-center justify-center flex aspect-square ${selectedMenu === item.name
                      ? "text-accentColor"
            ...
            {/* section bawah */}
            <div className="">
              <span className="hidden lg:block text-sm text-fontPrimaryColor/75">Wanna try?</span>
              ...
              <div className="mt-2 flex flex-col lg:flex-row justify-between items-center text-sm gap-2 lg:gap-0">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-6 fill-none stroke-white stroke-[2px]">
                ...
                >
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-6 fill-red-500 stroke-[0.5px] stroke-red-500">
                    <g>
